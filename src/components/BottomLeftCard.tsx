  ...
  return (
    ...
    >
      <div className="flex flex-col">
        <span className="text-2xl md:text-3xl font-normal text-[rgba(30,50,90,0.9)] tracking-tight">One photo</span>
        <span className="text-[10px] md:text-[12px] font-normal text-[rgba(30,50,90,0.6)] uppercase tracking-wider">Starts the workspace</span>
      </div>
      ...
      >
        ...
        <span className="text-[14px] font-normal text-[rgba(30,50,90,0.9)]">Capture a room</span>
      </motion.button>
    </motion.div>
  );
}
